...
for Width=2;
    ...
    for i=1:10
        ...
        save(['Single_pop_',num2str(i),'_L_',num2str(Length),'_W_',num2str(Width),'.mat'],'t_vec','z_vec','Width','Length','-v7.3')
    end
...
for i=1:Length*Width
    ...
    if i>Length*Width-Length
        R = [R;W(i)*(1-W(i-Length*Width+Length))];
        L = [L;W(i-Length*Width+Length)*(1-W(i))];
    end
    if mod(i,Length)~=0
        U = [U;W(i+1)*(1-W(i))];
    end
